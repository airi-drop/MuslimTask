...
const AmalChart = dynamic(() => import('@/components/AmalChart').then(m => ({ default: m.AmalChart })), {
  ssr: false,
  loading: () => <div className="h-[160px] w-full bg-bg-surface rounded-xl animate-pulse" />,
});
